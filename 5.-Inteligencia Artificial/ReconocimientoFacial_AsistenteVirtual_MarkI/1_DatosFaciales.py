...
usuario = "di_cer0"
ruta = "C:/Users/diego/OneDrive/Documents/The_MechaBible/p_Python_ESP/5.-Inteligencia Artificial/UsuariosReconocimientoFacial"
...
while True:
    ...
    for (x, y, ancho, altura) in caras:
        ...
        #fuera hueco, en esta parte se indicaría el grosor del borde del rectángulo en pixeles.
