...
if (__name__ == "__main__"):
    ...
    visionAsistenteVirtual = visionArtificial() #Instancia de la clase visionArtificial.
    ...
    while True:
        try:
            ...
            #de la clase widgetAlarma programa una alarma en la hora que el usuario haya indicado.
                ...
                #parántesis.
                hiloVision = threading.Thread(target = visionAsistenteVirtual.reconocerColoresVideo)
