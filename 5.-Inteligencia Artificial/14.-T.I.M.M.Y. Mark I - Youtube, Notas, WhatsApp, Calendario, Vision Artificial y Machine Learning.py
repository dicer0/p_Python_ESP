...
autentificacionGoogleCalendar = API_Keys.googleCalendar_auth.servicioAPIGoogleCalendar()
...
if (__name__ == "__main__"):
    ...
    calendarioAsistenteVirtual = widgetGoogleCalendar(autentificacionGoogleCalendar)
    ...
    while True:
        try:
            ...
            if any(palabra in preguntaUsuario for palabra in ["adiós, timmy.", "bye, timmy.", "adiós, tímí.", "adiós, dimi.", "adiós, teamy.", "¡bye, timmy!", "adios timmy", "bye timmy"]):
            ...
            #any():Función que recibe un bucle for que recorrerá un diccionario, lista o tupla para después 
            #retornar un valor booleano True cuando al menos uno de sus elementos sea True o distinto a None.
            elif any(palabra in preguntaUsuario for palabra in ["llegó", "llego", "llegar", "ruta", "direcciones", "distancia", "viaje", "mapa", "tráfico", "navegación"]):
            ...
            #una alarma.
            elif any(palabra in preguntaUsuario for palabra in ["vision", "visión", "visión artificial", "vision artificial", "ver color", "ver colores"]):
                ...
                vozAsistenteVirtual.hablar("Hola di0, he activado mi visión artificial para reconocer colores, para cerrar la cámara da clic en la tecla c.")
            ...
            #los colores rojo, verde, azul o amarillo de su entorno.
            elif any(palabra in preguntaUsuario for palabra in ["facial", "reconocimiento", "reconocimiento facial", "rostro", "cara"]):
                ...
                vozAsistenteVirtual.hablar("Hola di0, he activado mi reconocimiento facial, si no te reconozco preparate para morir!! Ah y para cerrar la cámara da clic en la tecla r.")
                #threading.Thread().start(): Una vez creado el nuevo hilo con el constructor de la clase Thread, se 
                #inicializará su ejecución con el método start().
                hiloVision.start()
                print("--Ok di_cer0, he activado mi reconocimiento facial, si no te reconozco preparate para moriir--")
            ...
            vozAsistenteVirtual.hablar("Lo siento, no escuché bien lo que dijiste debido a un error, repitelo porfa.")
