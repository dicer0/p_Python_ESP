...
if (__name__ == "__main__"):
    ...
    vozAsistenteVirtual.hablar("Hola soy TIMMY Mark 1, tu asistente virtual, puedo mimetizar tu voz y reproducir canciones en YoTube, en que te puedo ayudar?")
    while True:
        try:
            ...
            #programa.
            if (respuestaAsistenteVirtual == " adiós, timmy." or respuestaAsistenteVirtual == " bye, timmy." or respuestaAsistenteVirtual == " adiós, tímí." or respuestaAsistenteVirtual == " adiós, dimi." or respuestaAsistenteVirtual == " adiós, teamy." or respuestaAsistenteVirtual == " ¡bye, timmy!" or respuestaAsistenteVirtual == " bye, timmy!"):
