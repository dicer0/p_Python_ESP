...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        iconPath = "C:/Users/diego/OneDrive/Documents/The_MechaBible/p_Python_ESP/a1.-Data Science/0.-Archivos_Ejercicios_Python/Img/LogoBlancoDi_cer0.png"
        ...
        self.btn_start.setStyleSheet("background: qlineargradient(x1:0, y1:1, x2:0, y2:0, stop:0 rgb(255,255,255), stop:1 rgb(91,150,242));")
        self.btn_stop.setStyleSheet("background: qlineargradient(x1:0, y1:1, x2:0, y2:0, stop:0 rgb(255,255,255), stop:1 rgb(150,0,0));")
        ...
        lbl_com_port = QtWidgets.QLabel(text = "<p style='background: qlineargradient(x1:0, y1:1, x2:0, y2:0, stop:0 rgb(41,54,108), stop:1 rgb(34,15,64)); font-size: 15px; font-family: Courier New, monospace; color: white;'>COM Port: </p>")
        lbl_samples = QtWidgets.QLabel(text = "<p style='background: qlineargradient(x1:0, y1:1, x2:0, y2:0, stop:0 rgb(41,54,108), stop:1 rgb(34,15,64)); font-size: 15px; font-family: Courier New, monospace; color: white;'>Samples: </p>")
        ...
        #   esta no es admitida por PyQt5:
        #   background: qlineargradient(x1:punto_inicial, y1:punto_inicial, x2:punto_final, y2:punto_final, stop:0 rgb(R_inicial,G_inicial,B_inicial), stop:1 rgb(R_final,G_final,B_final));
        self.cb_port.setStyleSheet("font-size: 15px; font-family: Courier New, monospace; color: black; background: qlineargradient(x1:0, y1:1, x2:0, y2:0, stop:0 rgb(255,255,255), stop:1 rgb(91,150,242));")
        ...
        #   esta no es admitida por PyQt5:
        #   background: qlineargradient(x1:punto_inicial, y1:punto_inicial, x2:punto_final, y2:punto_final, stop:0 rgb(R_inicial,G_inicial,B_inicial), stop:1 rgb(R_final,G_final,B_final));
        spb_samples.setStyleSheet("font-size: 15px; font-family: Courier New, monospace; color: black; background: qlineargradient(x1:0, y1:1, x2:0, y2:0, stop:0 rgb(255,255,255), stop:1 rgb(91,150,242));")
...
if(__name__ == "__main__"):
    ...
    #   esta no es admitida por PyQt5:
    #   background: qlineargradient(x1:punto_inicial, y1:punto_inicial, x2:punto_final, y2:punto_final, stop:0 rgb(R_inicial,G_inicial,B_inicial), stop:1 rgb(R_final,G_final,B_final));
    window.setStyleSheet("background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 rgb(15,2,35), stop:1 rgb(4,27,121)); color: gray;")
