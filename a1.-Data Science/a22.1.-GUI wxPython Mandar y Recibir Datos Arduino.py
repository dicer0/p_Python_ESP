...
class TopPanel(wx.Panel):
    ...
    def update_graph(self, x, y0, y1, u):
        ...
        self.axes.plot(x, y1, 'r2--') #'r.--' c: color rojo, 2: tri_up, --: linea punteada.
    ...
    def TimeInterval(self,event):
        ...
        if(self.serialConnection == True):
            ...
            try:
                ...
                #   el pin. 
                #       - Placa Arduino: Este valor suele estar en un rango de 0 a 1, donde 0 coresponde al 
                ...
                self.time = self.time + 0.5     #Variable intermedia que cuenta el tiempo de ejecución del programa.
                ...
                if(VoltsA0 > umbral):
                    ...
                    #pin digital específicado de la placa, controlando si su estado está en alto (1 o True) o 
                    #bajo (0 o False).
                    ...
                    #controlar la salida de un pin analógico se debe usa el método analog_write().
