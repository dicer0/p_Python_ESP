        ...
        try:
            ...
            for indDicc in compareDicc:
                ...
                if not filtered.empty:
                    ...
                    contentStatus = "standard" if (standardContent in filtered.iloc[0]["contenido"]) else "not conventional"
                    finalData.append({
                        "Titulo Static": indDicc["tituloStatic"],
                        "Content Status": contentStatus,
                        "Dato Static": indDicc["datoStatic"],
                        "Titulo": filtered.iloc[0]["titulo"],
                        "Fecha de Publicacion": filtered.iloc[0]["fecha_publicacion"]
                    })
                else:
                    finalData.append({
