...
#CONFIGURAR LA CONEXIÓN A DISTINTOS TIPOS DE BASES DE DATOS:
#MySQL:
mysql_engine = create_engine('mysql+pymysql://username:password@hostname:port/database_name')
#PostgreSQL:
postgresql_engine = create_engine('postgresql://username:password@hostname:port/database_name')
#SQLite (path relativo):
sqlite_engine_relative = create_engine('sqlite:///mydatabase.db')
#SQLite (path absoluto):
